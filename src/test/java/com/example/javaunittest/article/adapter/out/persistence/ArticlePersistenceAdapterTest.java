...
import com.example.javaunittest.out.persistence.ArticleJpaEntityFixtures;
...
public class ArticlePersistenceAdapterTest {
    ...
    void modifyArticle() {
        ...
        var articleJpaEntity = new ArticleJpaEntity(boardJpaEntity, "new subject", "new content", "new user",
                LocalDateTime.parse("2024-09-16T11:12:33"));
