package com.example.javaunittest.article.in.api;

import com.example.javaunittest.article.adapter.out.persistence.repository.ArticleRepository;
...
@Sql("/com/example/javaunittest/article/in/api/ArticleControllerIntTest.sql")   // default value : same package, same class name
